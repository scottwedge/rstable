...
async def on_message(message):
	...
	######################################
		...
		cv2.putText(template, 'RANK', (150, 55), 2, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
		cv2.putText(template, '#' + str(rank), (200, 50), 5, 1.5, (255, 255, 255), 2, cv2.LINE_AA)
		cv2.putText(template, 'LEVEL', (250, 55), 2, 0.5, (110, 238, 77), 1, cv2.LINE_AA)
		cv2.putText(template, str(level), (300, 50), 5, 1.5, (110, 238, 77), 2, cv2.LINE_AA)
