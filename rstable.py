...
async def on_message(message):
	...
	######################################
		...
		cv2.putText(template, str(message.author), (150, 125), 5, 1.3, (255,255,255), 2, cv2.LINE_AA)
		cv2.putText(template, 'Level ' + str(level) + ' | Rank #' + str(rank) + ' / ' + str(len(message.server.members)), (150, 60), 5, 1.2, (255,255,255), 1, cv2.LINE_AA)
		cv2.putText(template, str('{:,}'.format(xp)) + ' / ' + str('{:,}'.format(left)) + ' XP', (420, 125), 5, 0.8, (245, 108, 240), 1, cv2.LINE_AA)
