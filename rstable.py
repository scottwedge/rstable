...
async def on_message(message):
	...
	######################################
		...
		cv2.putText(template, 'Level ' + str(level) + ' | Rank #' + str(rank) + ' of ' + str(len(message.server.members)), (200, 60), 5, 1.3, (255,255,255), 1, cv2.LINE_AA)
		cv2.putText(template, str(xp) + ' / ' + str(left) + ' XP', (420, 120), 5, 0.8, (245, 108, 240), 1, cv2.LINE_AA)
