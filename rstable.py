...
async def on_message(message):
	...
	######################################
		...
		cv2.rectangle(template, (0, 0), (600, 200), (52, 48, 47), 3)
		cv2.rectangle(template, (7, 7), (593, 193), (52, 48, 47), 2)
		cv2.putText(template, str(message.author), (150, 130), 5, 1.3, (255,255,255), 2, cv2.LINE_AA)
		cv2.putText(template, 'RANK', (350, 70), 5, 1, (255, 255, 255), 1, cv2.LINE_AA)
		cv2.putText(template, '#' + str(rank), (380, 60), 5, 1.5, (255, 255, 255), 2, cv2.LINE_AA)
		cv2.putText(template, 'LEVEL', (400, 70), 5, 1, (255, 255, 255), 1, cv2.LINE_AA)
		cv2.putText(template, str(level), (450, 60), 5, 1.5, (110, 238, 77), 2, cv2.LINE_AA)
